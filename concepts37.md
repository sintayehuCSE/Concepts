...
NoSQL databases address all kinds of requirements, and therefore the ways they work are dramatically different. Here’s a really accurate map of the various solutions: [Cassandra vs mongodb](http://kkovacs.eu/cassandra-vs-mongodb-vs-couchdb-vs-redis)
